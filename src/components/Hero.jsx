...
export default function Hero() {
    ...
    return (
        <section ref={comp} aria-label="Hero Introduction" className="hero-container relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="z-10 text-center pointer-events-none px-4 sm:px-6 mb-8 md:mb-16 mt-24">
            ...
            <div className="z-20 w-full max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 px-4 perspective-1000 flex-shrink-0" aria-hidden="true">
